...
#runs calculation for rooster number, not clear on how % works. 25*3%4=3, calculation is 97? after some more practice and cohortmate discussion, % functions to return the remainder
