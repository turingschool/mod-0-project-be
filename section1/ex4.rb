...
#print print string with cars variable
puts "There are #{cars} cars available."
#print string and variable drivers variable
puts "There are only #{drivers} drivers available."
#print string and how many cars won't be needed with the results of the computation cars minus drivers
puts "There will be #{cars_not_driven} empty cars today"
#print stiring and how many people will be moved with the results of the computation cars_driven * space_in_a_car
puts "We can transport #{carpool_capacity} people today."
#print string and variable passengers
puts "We have #{passengers} to carpool today."
#print string and computations result of passengers / cars_driven
