...
p "In a predicatble result, the #{slow_poke} beat the #{speedy}!"
...
p "I enjoy playing #{fun_game} so much, I have played it for #{hours_played} hours. Do I have a life? #{life}."
