...
umbridge_quote = "'Harry Potter must not return to Hogwarts!'"
puts umbridge_quote
...
# For first_name, I needed to input the word "Johnny", which is a string that
# must be surrounded in ""

# For is_hungry, you can only be hungry or not hungry, which should be represented
# as a boolean, or in this case, true

# For number_of_pets, that should only be represented by an integer, in this
# case 0
