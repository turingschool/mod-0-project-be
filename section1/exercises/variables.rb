...
# first_name seemed like it had to contain a string, whereas is_hungry seemed
# more like a boolean/binary/yes or no scenario.
# number_of_pets contains the word number in the variable and so an integer
# seemed like the best answer, though a string "none" would also have been
# viable.
