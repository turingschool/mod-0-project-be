...
# Explain.
# I used a string for first_name because it's a name
# I used a boolean for is_hungry because it's either true or false
# I used a number for number_of_pets because it's an integer
