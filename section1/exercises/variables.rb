...
# Explain.
# A name is a word so a string works best
# Being hungry is a yes/no question so true/false boolean works best
# Number of pets is a numerical value so a number works best
