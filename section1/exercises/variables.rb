...
# Explain.
#A name is a string, my hunger is a boolean because its true of false, and number of pets can be expressed at a string, integer or float but an integer makes the most sense.
