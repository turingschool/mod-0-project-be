...
dobby_speaks = "Harry Potter must not return to Hogwarts!"
p dobby_speaks
...
is_hungry = "always"
number_of_pets = 0
p "#{first_name} is #{is_hungry} hungry, and this is why he has #{number_of_pets} pets remaining"
# IN WORDS:
# How did you decide to use the data type you did for each of the three variables above?

# Explain. Strings we're the easiest for the first two and the second was asking
# for an integer.
...
is_hungry = "rarely"
number_of_pets = 6
p "#{first_name} is #{is_hungry} hungry so he still has all #{number_of_pets} of his pets left"
# YOU DO:
