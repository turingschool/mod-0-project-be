...
puts "The student #{first_name} has a big appetite #{is_hungry} and has #{number_of_pets} dog."
...
#
# Explain.
# I used the data type that could represent the variables related to me and that would make sense.
...
puts "The #{Kevin} student seems to eat #{always} with his pet #{one}."
