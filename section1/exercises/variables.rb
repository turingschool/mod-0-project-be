...
comment = "Harry Potter must not return to Hogwarts!"
p comment
...
puts "#{first_name} #{is_hungry}. They have #{number_of_pets} pets."

# IN WORDS:
# How did you decide to use the data type you did for each of the three variables above?

# I used string interpolation to insert the 3 variables in the string.

# Explain.
# Plugged each variable inside #{} in the sentence borded by double quotes.
