...
string = "#{name} must not return to Hogwarts!"
p string
...
# first_name refers to a name that it typically a string.  is_hungry is
# going to be either true or false which is Boolean.  number_of_pets is
# going to be an integer because it will always be a whole number.
