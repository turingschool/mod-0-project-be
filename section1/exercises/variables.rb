...
# Explain.
# first_name is asking for a word so I chose string.
# is_hungry is a yes or no question so a boolean is sufficient
# number_of_pets is asking for a whole number so integer is best.
