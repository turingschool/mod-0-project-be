...
# animals from above.
puts "There are #{animals.count} animals in this array."
...
foods = ['apples', 'peaches', 'plums', 'cherries']
...
new_foods = ['corn', 'cornbeef', 'potatoes']
foods.push new_foods
foods.flatten
