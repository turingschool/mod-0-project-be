...
# animals from above.
print "Number of elements in array is #{animals.length}"
...
pizza_ingredients = ["olives", "mushrooms", "cheese", "peppers"]
print pizza_ingredients

# YOU DO: Write code below that will print the number of elements in the array of
# foods from above.
print "Number of elements in pizza ingredients are #{pizza_ingredients.length}."

# YOU DO: Write code below that uses a method to add "broccoli" to the foods array and
# print the changed array to verify "broccoli" has been added
pizza_ingredients [4] = "brocolli"
print pizza_ingredients

# YOU DO: Write code below that removes the last item of food from the foods array and
# print the changed array to verify that item has been removed

pizza_ingredients.delete_at(4)
print pizza_ingredients
# YOU DO: Write code to add 3 new foods to the array.
  # There are several ways to do this - choose whichever you'd like!
# Then, print the changed array to verify the new items have been added
pizza_ingredients.push ("pineapple"),  ("bbq_sauce"),  ("anchovies")
print pizza_ingredients
# YOU DO: Remove the food that is in index position 0.

pizza_ingredients.delete_at(0)
print pizza_ingredients
#-------------------
