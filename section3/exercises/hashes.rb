...
zoo = {elephants: 2, penguins: 20, birds: 12}#YOUR CODE HERE
p zoo
...
#email = {"from" => "nikky", "to" => "family", "subject" => "special_note", "compose_email" => "i_love_you"}
email = {from: "nikky", to: "family", subject: "special_note", compose_email: "i_love_you"}
...
emails = ["nikky", "hubby", "mom"]
emails = [
  {
    from: "nikky",
    to: "family",
    subject: "special_note",
    compose_email: "i love you!!!"
  },
  {
    from: "husband",
    to: "nikky",
    subject: "re: i love you!!!",
    compose_email: "i love you too!"
  },
  {
    from: "mom",
    to: "nikky",
    subject: "re: i love you too!",
    compose_email: "Love you too hunny, miss you!"
  }
]
puts emails
