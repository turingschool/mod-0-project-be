...
# you created above:
puts '---------'
puts "the value of the first animal in the zoo is #{zoo[:bears]}"
...
email = {sender: "jim riddle", recipient: "jim's wife", subject: "Why I'm sorry this time", paragraphs: 6, signature: "I'm Sorry"}
