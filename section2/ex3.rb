...
def door_roulette
  ...
  if door == "1"
    ...
    puts "Do you: "
    puts "1. Freak out and get killed"
    puts "2. Square up and duel!"
    puts "3. Play dead"
    ...
    fight = gets.chomp
      ...
      if fight == "1" || fight == "3"
        puts "This did not work. Say hi to Lily, James and Sirius. You are dead. It was quick"
      elsif fight == "2"
...
#  puts "Thanks for playing!"
#else
#  puts "That wasn't an option, so goodbye anyway."
#end
