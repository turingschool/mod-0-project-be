    ...
    if gear == "1"
      ...
      if place == "1"
        ...
        if intention == "1"
          ...
          puts "None of them hit. You're brand new to the bow and you're just lucky you didn't hurt yourself."
          puts "Honestly, this shit's scary. Why did you choose an adventure at the start of a literal war?"
          puts "Is it the hero-complex? That only works if you have the training for it, my dude."
          ...
          puts "You creep about the walls of the castle, peering in windows, looking for your mark."
          puts "Your arrows are super rattle-y in the quiver though, so you manage to wake the whole castle."
          puts "Long before you find your mark, too. The guards have strong, warm hands as they yank you down."
          ...
          puts "You're a new recruit, with a bow thrust into your hands, and some orders barked in your general direction."
          puts "A grizzled soldier sits in your battlment smoking a pipe with their feet kicked up on the edge of the brazier."
          puts "They nod in your direction."
          puts "As you fiddle with arrow positioning, and try to figure out how to fire the darned thing, they speak up."
          puts "Their voice is just as grizzled as their appearance, though they use their words in a gentle way."
          puts "It seems they remember being 'green', and have decided to help train you."
          puts "After a while, you're actually pretty good! Under their guidance, you can hit a target almost every time."
          puts "And then, after some more time, you can hit a target every time, from 300 meters away!"
          puts "Your mentor-turned-friend claps you on the shoulder and offers you a sip from their flask."
          puts "Years pass, and a new green recruit shows up in your station. Your friend nods to you."
          puts "You put your pipe down, and sidle over to them, showing them the proper way to hold the bow..."
        else
        ...
        if intention == "1"
          ...
          puts "You get a lot of advice from a bunch of people who don't really understand the realities of what you'll be doing."
          ...
          puts "And what with it being a dystopian future and all, the powers that be quickly put an end to your little food operation."
          puts "You tried."
          puts "But for people who have only known starvation, is it actually worse for them now that they've know fullness?"
