...
# => elsif is telling ruby that if the above boolean was false to move on to the new boolean following the elsif method.
# => else is telling ruby that if all the above booleans were false to execute the following method. 
