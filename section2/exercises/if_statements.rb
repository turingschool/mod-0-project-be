...
# what you should take with you based on the following conditions:
  ...
  weather = 'clear' # changed from snowy to clear
...
# output: I dont't have enough money for a gumball
...
# output: I have enough money for a gumball
# The first condition was true, so the first puts statement was output.
