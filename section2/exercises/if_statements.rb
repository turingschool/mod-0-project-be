...
if cups_of_flour >= 2 and has_sauce == true
  p "You have the ingredient to make a pizza!"
elsif cups_of_flour >= 2 and has_sauce == false
  p "missin sauce, can not make pizza"
elsif cups_of_flour < 2 and has_sauce == true
  p "missin flour, can not make pizza"
else
  p "You're missing the ingredients, Can not make pizza!"
end
