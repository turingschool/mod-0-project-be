...
#Nothing happens if the code under the if is not indented, I was able to run the code still. This leads me to believe that the indentation is intended to present an easier-to-read format.

#Can you put other boolean expressions from Exercise 27 in the if-statement? Try it.

#I played around with this a little, I was able to run code with != (does not equal) but got the above error message in line 39 when using 'true'.  I went through Exercise 27 and looked at the terms but didn't want to spend too much time on it. Definitely need more practice with booleans!
