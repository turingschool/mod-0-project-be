...
decree = "Harry Potter must not return to Hogwarts!"
p decree
...
#first_name needs to be a string because it is a collection of letters
#is_hungry is boolean because it can only be true or false
#number_of_pets is a variable because it is a number
